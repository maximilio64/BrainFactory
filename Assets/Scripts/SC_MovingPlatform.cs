...
public class SC_MovingPlatform : MonoBehaviour
{
    ...
    void OnControllerColliderHit(ControllerColliderHit hit)
    {
        ...
        {
            if (activePlatform != hit.collider.transform && hit.collider.gameObject.layer != LayerMask.NameToLayer("mushroom") && hit.collider.gameObject.layer != LayerMask.NameToLayer("enemy"))
            {
